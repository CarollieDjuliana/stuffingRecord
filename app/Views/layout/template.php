...
<head>
    ...
    <link rel="icon" href="<?php echo base_url('/assets/images/logo_tab.png'); ?>" type="image/png" sizes="32x32">
            ...
            <ul class="list-unstyled px-2">
                <div class="button-container">
                    <li><a href="/dashboard" class="btn btn-light dashboard-button"><i class="fa-solid fa-house"></i>
                            Dashboard</a></li>
                    <li><a href="/activity" class="btn btn-light activity-button"><i class="fa-solid fa-chart-simple"></i>
                            Activity</a></li>
                    <li><a href="/profile" class="btn btn-light profile-button"><i class="fa-solid fa-user"></i>
                            Account</a></li>
                    <li><a href="/logout" class="btn btn-light"><i class="fa-solid fa-right-from-bracket fa-rotate-180"></i> Log Out</a></li>
                </div>
            </ul>
